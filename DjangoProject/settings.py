...
EMAIL_HOST = 'from django.conf import settingsroxketmedia.digital'  # Usually mail.yourdomain.com
...
EMAIL_HOST_USER = 'contact@roxketmedia.digital'
EMAIL_HOST_PASSWORD = 'admincontact11'
DEFAULT_FROM_EMAIL = 'contact@roxketmedia.digital'
